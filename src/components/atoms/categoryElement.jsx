  ...
  return (
    <>
      <Link to={absolute_url} className="category w-2/5 relative">
        ...
        <p className="w-full capitalize md:text-3xl text-xl text-white font-thin absolute top-0 left-0 backdrop-saturate-50 backdrop-blur-sm hover:opacity-0 transition flex items-center justify-center h-full">
          {url}
        </p>
      </Link>
    </>
